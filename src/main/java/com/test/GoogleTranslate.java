...
public class GoogleTranslate {
    ...
    private static void scan() {
        ...
        try {
            ...
            while (!line.equals("99")) {
                if (line.length() > 2) {
                    if (line.equals("tra")) {
                        System.out.println("Google translate called");
                        Runtime.getRuntime().exec("xdg-open https://translate.google.com/");
                    } else if (line.equals("rev")) {
                        System.out.println("Reverso Context called");
                        Runtime.getRuntime().exec("xdg-open https://context.reverso.net/%D0%BF%D0%B5%D1%80%D0%B5%D0%B2%D0%BE%D0%B4/");
                    } else if (line.equals("open")){
                        System.out.println("Open file " + fullPath);
    ...
    private static void writeToFile(String word, String translate) {
        try {
            fullPath = pathToFile + "/" + fileName + ".txt";
